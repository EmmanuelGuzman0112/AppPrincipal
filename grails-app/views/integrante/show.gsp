...
<html>
    ...
    <body>
        ...
        <div id="show-integrante" class="content scaffold-show" role="main">
            ...
            <f:display bean="integrante" />
            <g:form resource="${this.integrante}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.integrante}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
