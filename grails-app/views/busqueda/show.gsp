...
<html>
    ...
    <body>
        ...
        <div id="show-busqueda" class="content scaffold-show" role="main">
            ...
            <f:display bean="busqueda" />
            <g:form resource="${this.busqueda}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.busqueda}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
