...
<html>
    ...
    <body>
        ...
        <div id="show-postulacion" class="content scaffold-show" role="main">
            ...
            <f:display bean="postulacion" />
            <g:form resource="${this.postulacion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.postulacion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
