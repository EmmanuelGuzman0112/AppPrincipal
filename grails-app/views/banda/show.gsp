...
<html>
    ...
    <body>
        ...
        <div id="show-banda" class="content scaffold-show" role="main">
            ...
            <f:display bean="banda" />
            <g:form resource="${this.banda}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.banda}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
